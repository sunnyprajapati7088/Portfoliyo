  ...
  return (
    <div className="h-full relative z-[-2px] p-4">
      <div className=" w-full  h-[80%] lg:h-[50%] md:h-[50%]  lg:flex  lg:items-center lg:justify-center lg:gap-6 lg:p-16 md:justify-center md:flex md:flex-row  ">
        ...
        <div className=" flex  justify-center p-8 pt-12  h-[80%] items-center lg:w-[45%] md:w-[30%] md:items-center   ">
          ...
          <img
            src="https://res.cloudinary.com/drz6fzlpu/image/upload/v1729489873/sunny_kw8tjb.jpg"
